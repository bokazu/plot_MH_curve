...
for i=18:36
    ...
    output_szz_filename = "img/Ykapellasite/szz_rel_36site_"*string(i)*".png"
    output_szz_c_filename = "img/Ykapellasite/szz_c_rel_36site_"*string(i)*".png"
    ...
    marker_magnification = 20
    line_magnification = 40
    output_sxx_filename = "./img/Ykapellasite/sxx_rel_"*string(i)*".png"
    ...
    MHdata_output="img/Ykapellasite/MHcurve.png"
